...
%>
		...
		<link rel="stylesheet" type="text/css" href="<%=request.getSession().getAttribute("path") %>css/menu.css">
		...
		<link rel="stylesheet" type="text/css" href="<%=request.getSession().getAttribute("path") %>css/fieldsets.css">
