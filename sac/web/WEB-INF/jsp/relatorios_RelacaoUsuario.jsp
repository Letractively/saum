...
<div id="content-cliente" style="overflow: auto">
                	<table width="100%"><tr><td align="center">
						<display:table id="extratoBoleto" name="sessionScope.relacaoUsuario" 
							class="report" pagesize="30" export="true" sort="list" requestURI="/relacaoUsuarios.do"
							defaultsort="1">
							<display:setProperty name="export.excel.filename"
								value="relacaoUsuario.xls" />
							<display:setProperty name="export.pdf.filename"
								value="relacaoUsuario.pdf" />
								
							<display:column property="usuarioNome" title="Cliente" 
								sortable="true" headerClass="sortable"/>
							<display:column property="usuarioCpf" title="CPF/CNPJ" 
								sortable="true" class="telefonecss" headerClass="sortable"/>
							<display:column property="usuarioTelefone1" title="Telefone" 
								sortable="true" class="telefonecss" headerClass="sortable"/>
							<display:column property="usuarioCidade" title="Cidade"
								sortable="true" class="telefonecss" headerClass="sortable"/>
							<display:column property="usuarioDtPagamento" title="PG." 
							...
							<display:column property="usuarioId" title="Id" sortable="true"
								headerClass="sortable" class="pg"/>
						</display:table>
					</td></tr></table>
                </div>
                					       <!-- FIM -->
