...
<head>
	...
	<script type="text/javascript" src="<%=request.getSession().getAttribute("path") %>js/meganet/contato.js"></script>
					...
					<div id="content-cliente">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td colspan="2"><input name="usuario" type="text" id="usuario" size="50" maxlength="50" /></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td colspan="2" ><input name="cr" type="text" id="cr" size="50" maxlength="80" /></td>
                          </tr>
                          <tr>
                            <td><div align="right">Telefone:</div></td>
                            <td colspan="2"><input name="telefone" type="text" id="telefone" size="50" maxlength="13" onKeyDown="return formataTelefone(this, event)"/></td>
                          </tr>
                          <tr>
                            <td><div align="right">Mensagem:</div></td>
                            <td colspan="2"><textarea name="mensagem-texto" cols="100" rows="8" wrap="physical" id="mensagem-texto"></textarea></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                            <td colspan="2"><button onClick="enviaMensagem()"> Enviar </button></td>
                          </tr>
                        </table>
                        </div>                                            
                                            <!-- FIM -->
