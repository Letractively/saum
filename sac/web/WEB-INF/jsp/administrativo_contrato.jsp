...
<head>
	...
	<script type="text/javascript" src="<%=request.getSession().getAttribute("path") %>js/administrativo/contrato.js"></script>
	...
	<script type="text/javascript">
		tinyMCE.init({
			...
			content_css : "<%=basePath%>/js/editor/css/content.css",
	
			// Drop lists for link/image/media/template dialogs
			template_external_list_url : "<%=basePath%>/js/editor/lists/template_list.js",
			external_link_list_url : "<%=basePath%>/js/editor/lists/link_list.js",
			external_image_list_url : "<%=basePath%>/js/editor/lists/image_list.js",
			media_external_list_url : "<%=basePath%>/js/editor/lists/media_list.js",
    ...
    <div id="art-main">
        <div class="art-sheet">
            ...
            <div class="art-sheet-body">
                            		...
                            		<div class="art-post-inner art-article">
                                            <div class="art-postmetadataheader">
                                                <h2 class="art-postheader" style="padding-left: 3px;">
                                                    Inserção e alteração de contrato.
                                                </h2>
                                            </div>
				...
				<div>
                      <select style="width: 350px" name="select-altera-contrato" id="select-altera-contrato" onChange="carregaContratoParaAlteracao()">
                        <option selected value="-1">Selecione um contrato</option>
                      </select>&nbsp;&nbsp;
					  <button onclick="carregaContratoParaAlteracao()"> &nbsp;&nbsp;&nbsp;OK&nbsp;&nbsp;&nbsp; </button>
					  <br>
					<form action="#" id="form-altera-contrato" onsubmit="return false">
					  ...
					  <table width="99%" border="0">
                        <tr bgcolor="#DFE8F6">
                          ...
                          <td width="72%"><input name="nome" type="text" id="nome" size="50" maxlength="40" /></td>
                          <td width="7%">&nbsp;</td>
                          <td width="5%">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr bgcolor="#DFE8F6">
                          <td width="16%">&nbsp;</td>
                          <td width="72%"><button onclick="insereAlteraContrato()" id="bt-enviar"> &nbsp;&nbsp;Enviar&nbsp;&nbsp; </button></td>
                          <td width="7%">&nbsp;</td>
                          <td width="5%">&nbsp;</td>
                        </tr>
                      </table>
...
<script type="text/javascript">
	loginCookie();
	ContratoJS.buscaContratos(fnBuscaContratosCallBack);
</script>
</html>