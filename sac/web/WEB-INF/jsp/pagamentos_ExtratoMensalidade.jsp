                            		...
                            		<div class="art-post-inner art-article">
                                            <div class="art-postmetadataheader">
                                                <h2 class="art-postheader" style="padding-left: 3px;">
                                                    Extrato de mensalidades.<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(14, this);"> [?]</span>
                                                </h2>
                                            </div>
					...
					<div id="content-cliente" style="overflow: auto;">
						<form action="#" id="form-altera-cliente" onsubmit="return false">
								...
								<display:table id="extratoBoleto" name="sessionScope.extratoBoleto" 
									class="report" pagesize="15" export="true" sort="list" requestURI="/extrato.do"
									...
									<display:column property="boletosgeradosId" title="Número Boleto" 
									...
									<display:column property="dataTempPagamento" title="Data Pagamento" sortable="true"
									...
									<display:column property="boletosgeradosValorPago" title="Valor pago" sortable="true"
										headerClass="sortable" class="dtPg"/>
									<display:column property="estaPago" title="Situação"
										sortable="true" headerClass="sortable" class="pago" />
								</display:table>
								</td></tr></table>
						</form>
					</div>
