                            		...
                            		<div class="art-post-inner art-article">
                                            <div class="art-postmetadataheader">
                                                <h2 class="art-postheader" style="padding-left: 3px;">
                                                    Localizar boleto.<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(35, this);"> [?]</span></span></td>
                                                </h2>
                                            </div>
												...
												<div id="content-cliente" style="overflow: auto">
													<div>
														<form action="#" id="dd" onsubmit="return false">
															<input type="hidden" id="localiza-bol" value="<%=localizaBol %>"/>
															...
															&nbsp;&nbsp;<button onclick="carregaUsuario2()" style="margin-right: 15px"> OK </button>
															<label><input id="chk-hab-pag" type="checkbox" onclick="habilitaPagamento(this)"/> Informar pagamento.</label>
														</form>
												  	</div>
													<form action="#" id="form-altera-cliente" onsubmit="return false">
													<input name="id" id="id" type="hidden"/>
													<input type="hidden" id="input-temp" name="input-temp"/>
													<input type="hidden" id="id-bol" name="id-bol"/>
													<br/><br/>
													<table width="100%" border="0">
													  ...
													  <tr bgcolor="#DFE8F6">
													    ...
													    <td><input type="text" readonly="readonly" name="combo-alt-torre" size="25" id="combo-alt-torre"/></td>
													    <td><div align="right">Endereço IP:</div></td>
													    <td><input type="text" readonly="readonly" name="combo-alt-endereco-ip" size="25" id="combo-alt-endereco-ip"/></td>
													  </tr>
													  <tr>
													  ...
													  <tr bgcolor="#DFE8F6">
													    <td><div align="right">Id local:</div></td>
													    <td><input type="text" readonly="readonly" name="id-boleto" size="25" id="id-boleto"/></td>
													    <td><div align="right">Id F2B:</div></td>
													    <td><input type="text" readonly="readonly" name="id-f2b" size="25" id="id-f2b"/></td>
												      </tr>
													  <tr>
													  ...
													  <tr bgcolor="#DFE8F6">
													    ...
													    <td>&nbsp;</td>
													    <td>&nbsp;</td>
													    <td><button onclick="informaPagamentoEmMao()" id="bt-inf-pag" disabled="disabled"> Informar pagamento </button></td>
												      </tr>
													</table>
												</form>
												</div>
