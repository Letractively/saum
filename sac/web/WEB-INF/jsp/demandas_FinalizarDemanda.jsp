...
<head>
	...
	<script type="text/javascript" src="<%=request.getSession().getAttribute("path") %>js/demandas/finalizarDemanda.js"></script>
					...
					<table width="100%"><tr><td align="center">
						<display:table id="demandas-tb" name="sessionScope.demandas" 
							...
							<display:setProperty name="export.excel.filename"
								value="demandas-abertas.xls" />
							<display:setProperty name="export.pdf.filename"
								value="demandas-abertas.pdf" />
							...
							<display:column property="tecnicoAbriu" title="Tecnico abriu" sortable="true"
								headerClass="sortable" class="cliente"/>
				...
				<span id="content-solicita-demanda">
					<div>
                    	...
                    	<table width="100%" border="0" cellspacing="1" cellpadding="0">
                          ...
                          <tr>
                            <td width="25%"><div align="right" style="font-weight: bold">Origem do problema:</div></td>
                            <td><select name="combo-tp-erro" id="combo-tp-erro"></select></td>
                          </tr>
                          <tr>
                            <td><div align="right" style="font-weight: bold">Data atendimento:</div></td>
                            <td>
                          ...
                          <tr>
                            <td><div align="right" style="font-weight: bold">Hora atendimento:</div></td>
                            <td>
                          ...
                          <tr>
                            <td>&nbsp;</td>
                            <td>
					    		<button onclick="gravaDemanda()"> Encerrar demanda </button>
                            </td>
                          </tr>
                        </table>
				  	</div>
