...
<head>
	...
	<script type="text/javascript" src="<%=request.getSession().getAttribute("path") %>js/relatorios/utilizacaoGrupos.js"></script>
						...
						<div id="content-cliente" style="overflow: auto;">
	                        <table width="100%" border="0">
	                          <tr>
	                            ...
	                            <td align="left"><button onClick="buscaRelatorio()"> &nbsp;&nbsp;Enviar&nbsp;&nbsp; </button></td>
	                        </tr>
	                        </table>
