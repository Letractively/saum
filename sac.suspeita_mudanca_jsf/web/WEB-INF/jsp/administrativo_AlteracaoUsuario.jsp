...
<head>
	...
	<script type="text/javascript" src="<%=request.getSession().getAttribute("path") %>js/administrativo/alteraUsuario.js"></script>
            ...
            <div class="art-sheet-body">
                ...
                <div class="art-content-layout">
                            		...
                            		<div class="art-post-inner art-article">
                                            <div class="art-postmetadataheader">
                                                <h2 class="art-postheader" style="padding-left: 3px;">
                                                    Alteração de usuário.<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(3, this);"> [?]</span>
                                                </h2>
                                            </div>
					...
					<div>
						...
						&nbsp;&nbsp;<button onclick="carregaUsuariosParaAlteraccao()"> OK </button>
				  	</div>
					...
					<table width="100%" border="0">
					  <tr bgcolor="#DFE8F6">
					    ...
					    <td colspan="3"><input name="mac-alt" type="text" id="mac-alt" size="25" maxlength="17" onkeydown="return formataMAC(this, event)"/></td>
					  </tr>
					  <tr>
					    <td width="15%"><div align="right">Nome:</div></td>
					    <td><input name="usuario-alt" type="text" readonly="readonly" id="usuario-alt" size="50" maxlength="50" /></td>
					    <td width="15%"><div align="right">CPF/CNPJ:</div></td>
					    <td><input name="cpf-alt" type="text" id="cpf-alt" size="25" maxlength="14" readonly="readonly"/></td>
					  </tr>
					  <tr bgcolor="#DFE8F6">
					  ...
					  <tr bgcolor="#DFE8F6">
					    ...
					    <td>
					    	...
					    	&nbsp;&nbsp;CEP: <input name="cep-alt" type="text" id="cep-alt" size="9" maxlength="9" onkeydown="return formataCEP(this, event)" />
					    	<img src="img/check.png" onclick="buscaCEP();" style="cursor: pointer;"/>
					    </td>
					  ...
					  <tr>
					    ...
					    <td><select name="combo-contrato" style="width: 155px;" id="combo-contrato">
					  ...
					  <tr bgcolor="#DFE8F6">
					    ...
					    <td><div align="right">Endereço IP:</div></td>
					  ...
					  <tr valign="top">
					    ...
					    <td>
                            <select name="combo-cliente-bloqueado" style="width: 155px;" id="combo-cliente-bloqueado" onchange="verificaDataLimiteClientePagamentoAtrasado()">
                            ...
                            <div id="div-data-bloqueio" style="display: none;">
								...
								<img id="bt-dt-limite-bloqueio" src="img/calendar.gif" alt="Calendário" class="calendario" /><br/>
								<textarea id="motivo" style="width: 155px" maxlength="150" onclick="this.value = ''">Motivo do desbloqueio</textarea>
							</div>
                        </td>
				      </tr>
					  <tr bgcolor="#DFE8F6">
					    ...
					    <td>
                        	<input class="campo-data" readonly="readonly" name="dt-ativacao" type="text" id="dt-ativacao" size="20" maxlength="10" />
						</td>
					  ...
					  <tr bgcolor="#DFE8F6">
					    <td><div align="right">Usuario Adm.:<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(4, this);"> [?]</span></div></td>
					    <td colspan="4">
							<input type="checkbox" id="usuario-administrativo" name="usuario-administrativo" style="margin-top: 2px"/>
					    </td>
					  </tr>
					  <tr>
					    <td><div align="right">Paga em mão:<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(5, this);"> [?]</span></div></td>
					    <td colspan="4">
							<input type="checkbox" id="usuario-paga-mao" name="usuario-paga-mao" style="margin-top: 2px"/>
					    </td>
					  </tr>
					  <tr bgcolor="#DFE8F6">
					    <td><div align="right">E-mails monetários:<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(6, this);"> [?]</span></div></td>
					    <td colspan="4">
							<input type="checkbox" id="usuario-email-monetario" name="usuario-email-monetario" style="margin-top: 2px"/>
					    </td>
					  </tr>
					  <tr>
					  ...
					  <tr>
					    <td>&nbsp;</td>
					    <td><button onclick="alteraUsuario()" disabled="disabled" id="bt-enviar"> &nbsp;&nbsp;Enviar&nbsp;&nbsp; </button></td>
					    <td><button onclick="excluirUsuario()" disabled="disabled" id="bt-excluir"> &nbsp;&nbsp;Excluir&nbsp;&nbsp; </button></td>
					    <td>&nbsp;</td>
					  </tr>
					</table>
				</form>
