            ...
            <div id="content-msg" style="visibility: hidden;">&nbsp;</div>
            	<form action="#" id="dd" onsubmit="return false">
		            ...
		            <ul class="edit rounded">
		                ...
		                <li><button onclick="carregaUsuario2()" style="margin-right: 15px"> OK </button></li>
		            </ul>
		        </form>
		        <form action="#" id="form-altera-cliente" onsubmit="return false">
		            ...
		            <ul class="rounded">
		                ...
		                <li>Servidor:<input type="text" readonly="readonly" name="combo-alt-torre" id="combo-alt-torre"/></li>
		                <li>Endereço IP:<input type="text" readonly="readonly" name="combo-alt-endereco-ip" id="combo-alt-endereco-ip"/></li>
		                ...
		                <li>Id Local:<input type="text" readonly="readonly" name="id-boleto" id="id-boleto"/></li>
		                <li>Id F2B:<input type="text" readonly="readonly" name="id-f2b" id="id-f2b"/></li>
						...
						<li>Informar pagamento:<span class="toggle"><input id="chk-hab-pag" type="checkbox" onclick="habilitaPagamento(this)"/></span></li>
		                ...
		                <li>&nbsp;</li>
		                <li><button onclick="informaPagamentoEmMao()" id="bt-inf-pag" disabled="disabled"> Informar pagamento </button></li>
		            </ul>
		        </form>
        </div>
	</body>
