...
<head>
	...
	<script type="text/javascript" src="<%=request.getSession().getAttribute("path") %>js/administrativo/confAvancada.js"></script>
                            		...
                            		<div class="art-post-inner art-article">
                                            <div class="art-postmetadataheader">
                                                <h2 class="art-postheader" style="padding-left: 3px;">
                                                    Configurações avançadas.<span class="span-ajuda" onclick="foraInterClique();" onmouseover="sobreInter(49, this);"> [?]</span>
                                                </h2>
                                            </div>
...
<script type="text/javascript">
	loginCookie();
	UtilsJS.carregaDominios(fnCarregaDominiosCallback);
