...
/**
 * @author Fabio Souza
 * @version $Id: JBoletoBean.java,v 1.1 2012-05-11 18:48:35 cvs_user Exp $
 * Classe alterada por Flavio Brasil
 *
 */
public class JBoletoBean {
    
    public InfBoleto getInfBoleto() {
		return infBoleto;
	}

	public void setInfBoleto(InfBoleto infBoleto) {
		this.infBoleto = infBoleto;
	}
    ...
    private Vector<String> descricoes = null;
    ...
    /**
     * Metodo para gerar o fator de vencimento do boleto
     * 
     * @return long
     */
    ...
    /**
     * Retorna o número digitavel do codigo de barras
     * @return Retorna o número digitavel do codigo de barras
     */
    ...
    /**
     * Seta o número digitavel do codigo de barras
    ...
    /**
     * Retorna o número do codigo de barras
     * @return Retorna o número do codigo de barras
     */
    ...
    /**
     * Seta o número do codigo de barras
     * @param codigoBarrasDividido
     * Seta o número do codigo de barras
     */
     ...
     * Modulo 10 (212121)\n
     * Retorna o digito verificador de cada campo da linha digitavel. Voce deve passar como parametro a string do campo conforme o seu banco.\n
     * Nao tem a necessidade do mult e possui o mesmo efeito que o Metodo getDigitoCampo(String, int)
     * @return Retorna o digito verificador de cada campo da linha digitavel. Voce deve passar como parametro a string do campo conforme o seu banco.
     */
     ...
     * O tamanho ideal para a imagem e de: 1000x668 px
	...
	public String getUrlF2B() {
		return urlF2B;
	}

	public void setUrlF2B(String urlF2B) {
		this.urlF2B = urlF2B;
	}
