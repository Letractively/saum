...
public class ExemploNossaCaixa {
    ...
    public static void main(String args[]) {        
        ...
        for (int i = 0; i < 5; i++) {
            ...
            boleto.setLocalPagamento("Pague preferencialmente no Banco Nossa Caixa S.A. ou na rede bancária até o vencimento."); // obrigatório essa frase
            ...
            boleto.setInstrucao1("Texto e emissão do boleto de Responsabilidade do Cedente"); // texto exigido pelo banco
            boleto.setInstrucao2("Não Receber após o vencimento");
            boleto.setInstrucao3("Multa de 10% após vencimento");
