...
public class ValidaSSN_PRT extends ValidadorGeral {

	public ValidaSSN_PRT(String serial) {
		super(serial);
	}
	...
	public boolean valida() throws Exception {
		...
		if(serial.length() < 15 || serial.length() > 25)
			return false;
        else if(Character.isDigit(serial.charAt(serial.length() - 1)))
            return false;
	...
	public static void main(String[] args){
		ValidaSSN_PRT vm = new ValidaSSN_PRT("846NNS28D8");
		try {
