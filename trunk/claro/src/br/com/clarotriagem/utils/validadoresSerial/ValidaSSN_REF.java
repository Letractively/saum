...
public class ValidaSSN_REF extends ValidadorGeral {

	public ValidaSSN_REF(String serial) {
		super(serial);
	}
	...
	public boolean valida() throws Exception {
        ...
        if(serial.length() != 15)
            ...
            return false;
        else if(Character.isDigit(serial.charAt(7)))
            return false;
        else if(Character.isDigit(serial.charAt(8)))
            return false;
		else {
			if(a > ano)
				return false;
	...
	public static void main(String[] args){
		ValidaSSN_REF vm = new ValidaSSN_REF("846NNS28D8");
		try {
