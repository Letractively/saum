...
public class CalendarioGeralOuUsuarioNaoConcluidoListLazy extends LazyDataModel<Calendario> {
	...
	public CalendarioGeralOuUsuarioNaoConcluidoListLazy(CalendarioService calendarioService, boolean buscaTodos, UsuarioIdentificacao usrLogado) {
	...
	public List<Calendario> load(int startingAt, int maxPerPage, String sortField, SortOrder sortOrder, Map<String, String> filters) {
		this.listaCalendario = calendarioService.buscaCalendariosAbertos(startingAt, maxPerPage, sortField, sortOrder, buscaTodos, usrLogado);
