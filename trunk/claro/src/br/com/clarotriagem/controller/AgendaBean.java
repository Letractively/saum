...
@Scope("view")
@Component
public class AgendaBean extends AgendaFactory {

	private static final long serialVersionUID = 1851768216318239706L;
	...
	private void preencheAgenda(){
		List<Calendario> agenda = calendarioService.getAgendaUsuario(getUsuarioLogado());
